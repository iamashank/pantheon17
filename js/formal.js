      ...
      .done(function( data ) {
        ...
        setTimeout(function(){
          ...
          $('.modal-body').html(`
            ...
            <span style="color: rgba(52, 152, 219,1.0);">Points</span> - 1<sup>st</sup>: ${data.position1.points}, 2<sup>nd</sup>: ${data.position2.points}, 3<sup>rd</sup>: ${data.position3.points}<br>
            </p>
