      ...
      .done(function( data ) {
        ...
        setTimeout(function(){
          ...
          $('.modal-body').html(`
            ...
            <span style="color: rgba(52, 152, 219,1.0);">Points</span> - <b>1<sup>st</sup>:</b> ${data.position1.points}, <b>2<sup>nd</sup>:</b> ${data.position2.points}, <b>3<sup>rd</sup>:</b> ${data.position3.points}<br>
            </p>
